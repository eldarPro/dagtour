...
import { TourFilters, DEFAULT_FILTERS, PRICE_MIN, DurationFilter } from '../data/tourFilters';
...
const ToursFilterModal: React.FC<Props> = ({ isOpen, filters, priceMax, routePoints, onClose, onApply }) => {
